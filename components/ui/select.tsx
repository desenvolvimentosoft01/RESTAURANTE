...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        /* z-[200] garante que fica acima de qualquer campo do formulário */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-2 pl-8 pr-3 text-sm text-slate-700 outline-none",
      /* hover e focus com cor explícita */
      "focus:bg-slate-100 focus:text-slate-900",
      "hover:bg-slate-100 hover:text-slate-900",
      /* item selecionado com destaque */
      "data-[state=checked]:bg-amber-50 data-[state=checked]:text-amber-800 data-[state=checked]:font-semibold",
